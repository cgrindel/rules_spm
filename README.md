...
http_archive(
    ...
    sha256 = "761496f290fcf28ee1e606c3e3fcbfeae37f1c5e5e07a5e5420f58f44407516a",
    strip_prefix = "rules_spm-0.5.1",
    urls = ["https://github.com/cgrindel/rules_spm/archive/v0.5.1.tar.gz"],
)
