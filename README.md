...
http_archive(
    ...
    sha256 = "7da0cdd70faee3bcb2796fb79bcfd9f47f394ff17f65a187bd2023bfe0647bc7",
    strip_prefix = "rules_spm-0.5.0",
    urls = ["https://github.com/cgrindel/rules_spm/archive/v0.5.0.tar.gz"],
)
